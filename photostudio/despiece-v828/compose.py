"""Despiece / detalle por parte (MGM v8.2.14). Schema VERSION stays 8."""
...
def extend(html, root):
    ...
    once('<button id="saveFullOrder" class="primary full">Guardar pedido + ficha + logos</button>',
         '<details class="logo-prep" id="fichaDespieceBox"><summary>Despiece · detalle por parte</summary><p class="help">Uso interno. Nombre, notas, color y precio por parte. Toca una parte en Acabado → Despiece para editarla. No sale en el PDF del cliente. Precios vacíos = por definir.</p><div id="fichaDespieceRows" class="despiece-ficha-rows"></div></details>\n<button id="saveFullOrder" class="primary full">Guardar pedido + ficha + logos</button>')
